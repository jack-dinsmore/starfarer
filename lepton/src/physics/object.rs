...
pub struct Object {
    ...
    pub(crate) push_constants: shader::builtin::ObjectPushConstants,
...
impl Object {
    pub fn new(pos: Vector3<f64>, orientation: Quaternion<f64>) -> Self {
        Object {
            ...
            orientation,
            light_index: None,
            push_constants: shader::builtin::ObjectPushConstants {
    ...
    pub(crate) fn make_push_constants(&mut self) {
        if !self.push_constants_accurate { 
            self.push_constants = shader::builtin::ObjectPushConstants {
